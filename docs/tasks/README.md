...
| [T-02](T-02_javascript_typescript_language_pack.md) | JS/TS 언어팩 추가 | 김민수 | ✅ 머지됨 (PR #6) |
| [T-03](T-03_scan_cli.md) | `provenire scan` CLI (+ 인덱스 연결) | 김민수 | ✅ 머지됨 (PR #9) |
| [T-04](T-04_git_diff_adapter.md) | git diff 어댑터 (`scan --diff`) | 김민수 | ✅ 머지됨 (PR #16) |
| [T-05](T-05_github_action.md) | **GitHub Action + PR 코멘트** ⭐ | 김민수 | ✅ 머지됨 (PR #21) |
| [T-06](T-06_pypi_release.md) | PyPI 재배포 (v0.1.0) + README 마무리 | 김민수 | 🟢 진행 가능 |
